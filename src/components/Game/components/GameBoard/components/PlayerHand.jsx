...
function PlayerHand({ endTurn, drawCard, forceDisconnect }) {
    const { players, activeCard, setActiveCard, isGameActive, playDeck, discardDeck, isReverse, turn } = useGameContext();
    ...
    return (
        ...
        >
            <div>{`You will be disconnected in ${countdown} seconds`}</div>
            {playedWild && (
                <ChooseColorPrompt
