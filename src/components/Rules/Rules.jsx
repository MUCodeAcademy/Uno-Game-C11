        ...
        <DialogContent dividers={scroll === "paper"}>
          ...
          >
            ...
            <div>
              ...
              cards and tries to match the active card shown on the screen. You
              have to match either by the number, color, or the symbol/Action.
              For instance, if the active card is a red 8, you have to place
              either a red card or a card with an 8 on it. You can also play a
              Wild card (which can alter current color in play). If the player
              has no matches or they choose not to play any of their cards, they
              must draw a card from the Draw pile until a card is playable. The
              game then moves on to the next player's turn. You can also play a
              Wild card or a Wild Draw Four card on your turn.
              <br />
              <br />
            ...
            <ul>
              <li>
                Reverse – If the turn direction is moving forward, the direction
                switches to backward, and vice versa. In a two-player game, this
                card has no effect on the turn direction and the game proceeds
              ...
              <li>
                Draw Two – When a person places this card, the next player will
                have to draw two cards from the play deck, and their turn is
                skipped.
              </li>
              <li>
