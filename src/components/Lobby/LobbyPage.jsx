...
function LobbyPage() {
    ...
    useEffect(() => {
        ...
        socketRef.current.on("room full", ({ roomsID }) => {
            console.log("good");
        });
    ...
    const joinErrorMsg = useMemo(() => {
        if (!rooms.some((room) => room.id === joinRoomNum && room.playerCount < 6))
                    ...
                    >
                        <TextField
                            ...
                            error={
                                ...
                                !rooms.some((room) => room.id === roomNum && room.playerCount < 6)
                            }
                            onChange={(e) => {
                        ...
                        <Button
                            ...
                            onClick={(e) => {
                                ...
                                if (
                                    ...
                                    rooms.some(
                                        (room) =>
                                            room.id === joinRoomNum.replace(/\s+/g, "-").toLowerCase() && room.playerCount > 6
                                    )
                                ) {
                                    navigate(
